...
description: "How DormWay connects to LMS platforms via ICS feeds to sync courses, assignments, and schedules."
source:
  type: "obsidian"
  path: "Engineering/Technical/Engine/SoT LMS ICS Parsing.md"
  distilled_at: "2026-03-19"
---

# Canvas LMS Integration

DormWay syncs a student's course schedule and assignment due dates by parsing ICS (iCalendar) feeds from their LMS. The feed is fetched periodically, parsed into a normalized format, and stored as course-context-linked assignments.
...
- Sync orchestration details: [Sync Orchestration](/engineering/sync-orchestration)
