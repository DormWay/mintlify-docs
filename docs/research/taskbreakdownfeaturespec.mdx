...
4. Clicks button → Ace LLM analyzes task
5. Gets breakdown:
   ```
   📋 Research Paper Breakdown (8 steps)
   
   ✅ 1. Choose research topic (2 hours)
   ✅ 2. Find 5-7 academic sources (3 hours)
   ✅ 3. Create outline with thesis statement (2 hours)
   ✅ 4. Write introduction paragraph (1 hour)
   ✅ 5. Write body paragraphs (6 hours)
   ✅ 6. Write conclusion paragraph (1 hour)
   ✅ 7. Format citations and bibliography (1 hour)
   ✅ 8. Proofread and edit (2 hours)
...
```
┌─────────────────────────────────────┐
│ Task Breakdown: Research Paper      │
│ Progress: ████████░░░░ 4/8 steps    │
├─────────────────────────────────────┤
│ ✅ 1. Choose research topic (2h)   │
│ ✅ 2. Find 5-7 academic sources (3h)│
│ ✅ 3. Create outline (2h)           │
│ ⬜ 4. Write introduction (1h)       │
│ ⬜ 5. Write body paragraphs (6h)    │
│ ⬜ 6. Write conclusion (1h)         │
│ ⬜ 7. Format citations (1h)         │
│ ⬜ 8. Proofread and edit (2h)       │
├─────────────────────────────────────┤
│ Total: 18 hours | 4/8 complete     │
│ [Schedule Steps] [Regenerate]      │
└─────────────────────────────────────┘
```
...
Complexity levels:
- "low": Simple task, 3-5 steps, <10 hours
...
**UI:**
- Badge in Tasks Widget: "💡 Break this down?"
...
**Example:**
```
Step 1: Choose topic (2h) → Schedule for Dec 8
Step 2: Find sources (3h) → Schedule for Dec 9
Step 3: Create outline (2h) → Schedule for Dec 10
...
```
...
2. ✅ API endpoints
3. ✅ Ace LLM prompt
4. ✅ TaskDetailPopover "Break Down" button
5. ✅ Basic breakdown modal
6. ✅ Step completion tracking

### Phase 2: UI Polish (1-2 weeks)
1. ✅ Progress indicators in Tasks Widget
2. ✅ Breakdown view improvements
3. ✅ Regenerate breakdown
4. ✅ Export breakdown

### Phase 3: Smart Features (2-3 weeks)
1. ✅ Automatic breakdown suggestions
2. ✅ Step scheduling integration
...
**Implementation Priority:** 🔥🔥 HIGH - High student value, moderate technical complexity, strong differentiation
