...
- [DayPlan V1 Architecture](/docs/engineering/architecture/dayplan-v1-architecture) - Legacy implementation
- [Student Time Blocks](/docs/engineering/technical/calendar/schedules-time-blocks-and-reconciliation) - Unified assignment/schedule storage
- [Preferences Service](/docs/engineering/technical/dormway-core/domain-services/preferencesservice) - User preference management
