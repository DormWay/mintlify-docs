...
- `/v2/students/me/task-bank` returns unified unscheduled work (DayPlan suggestions, Canvas, quick captures, persistent tasks) for Smart Schedule. (`services/api-router/src/routes/v2/students.routes.ts`)
