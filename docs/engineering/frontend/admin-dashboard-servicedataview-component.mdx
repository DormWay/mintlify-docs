...
- [Campus Metadata View](/docs/engineering/frontend/campus-metadata-view) - Renders campus enriched metadata
- [Admin Dashboard Architecture](/docs/engineering/architecture/admin-console-deep-dive-improvement-plan-current) - Overall admin dashboard structure
