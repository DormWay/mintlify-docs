...
- Web + iOS typically call via the gateway proxy: `/api/proxy/api/v2/*` (Zuplo → api-router).
...
| POST `/v2/students/me/schedule/intent` | Intent parsing for Smart Schedule | `services/dormway-lockedin/src/app/dashboard/schedule/page.tsx` |
| POST `/v2/students/me/schedule-rules` | Create + materialize schedule rules | `services/dormway-lockedin/src/app/dashboard/schedule/page.tsx` |
| PATCH `/v2/students/me/schedule-rules/:id` | Update or pause schedule rules | `services/api-router/src/routes/v2/students.routes.ts` |
| POST `/v2/students/me/schedule-rules/:id/materialize` | Materialize rule blocks | `services/api-router/src/routes/v2/students.routes.ts` |
...
- GET `/v2/courses/:id/workload-analysis`
- GET `/v2/courses/:id/cost`
- GET `/v2/courses/:id/grade-strategy`
- GET `/v2/courses/:id/student-impact`
- GET `/v2/courses/:id/materials`
...
- POST `/v2/students/me/schedule/intent`
- GET `/v2/students/me/schedule-rules`
- POST `/v2/students/me/schedule-rules`
- PATCH `/v2/students/me/schedule-rules/:id`
