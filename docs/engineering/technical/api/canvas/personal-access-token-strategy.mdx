...
- ❌ Must contact IT department at **every university**
- ❌ Approval process takes 3-6 months **per school**
- ❌ IT can reject us (politics, competing products, etc.)
- ❌ Can only launch at 1-2 universities initially
- ❌ Scaling to 50+ universities = years of work
- ❌ **Kills our startup velocity**
...
| **Startup-Friendly** | ❌ No | ✅ Yes |

### **Industry Examples**

**Apps Using Personal Access Tokens**:
- ✅ **Notion** - GitHub integration (personal tokens)
- ✅ **Todoist** - Google Calendar sync (API keys)
- ✅ **IFTTT** - Webhooks (user-generated tokens)
- ✅ **Zapier** - Custom API connections
- ✅ **Alfred** - GitHub search (personal tokens)
...
│  (Works at ANY university)      │
│  [Connect with Token]           │
│                                 │
│  Option 2: OAuth Login          │
│  (If your school supports it)   │
...
│                                     │
│  ✓ Syncs automatically every 30min  │
...
2. **Auto-detect Canvas URL** - From student email domain (e.g., riley@umich.edu → umich.instructure.com)
...
- ✅ Student can revoke anytime in Canvas settings
- ✅ DormWay uses read-only operations (no writes)
...
- ✅ 10+ different universities in first month
- ✅ <10% drop-off during token connection
- ✅ <5% support tickets about token creation
...
## ✅ **Decision: Personal Access Token Primary, OAuth Optional**
