...
if (travel.isTraveling) {
  ...
  console.log(`Local weather: ${travel.travelWeather?.temperature}°F`);
}
// Output:
// User is 1959 miles from campus
// Current location: West Hills
// Local weather: 56.62°F
```
...
- Travel weather: 56.62°F (feels like 56.08°F)
```
...
- [Student Entity](/docs/engineering/technical/dormway-core/entity-system-guide#student-entity-daily-intelligence) - Student entity with travel enrichment
