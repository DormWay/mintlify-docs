...
| `getCost()` | (via syllabus) | `CourseCost \| null` |
| `getWorkloadAnalysis()` | (via syllabus) | `WorkloadAnalysis \| null` |
| `getGradeStrategy()` | (via syllabus) | `GradeStrategy \| null` |
| `getStudentImpact()` | (via syllabus) | `StudentImpact \| null` |
| `getRequiredMaterials()` | (via syllabus) | `string[]` |
