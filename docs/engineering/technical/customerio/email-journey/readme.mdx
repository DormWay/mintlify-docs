...
## ⚠️ **IMPORTANT UPDATE: Liquid Template System**
...
**New Files:**
- 📄 `customerio-liquid-base-template.html` - Base layout with header/footer
- 📚 `liquid-snippets-library.md` - Reusable HTML/Liquid snippets (copy-paste templates)
- 📋 `customerio-component-plan.md` - Updated implementation guide
- 📧 `example-welcome-email-liquid.html` - Complete example using new system
- ⭐ `CUSTOMER-IO-BEST-PRACTICES.md` - **START HERE** - Complete guide to Customer.io constraints
- 🔍 `AMPLITUDE_ATTRIBUTES_ANALYSIS.md` - **CRITICAL** - User property requirements for email campaigns

**Key Changes:**
- ✅ Better email client compatibility (table-based layouts)
- ✅ Matches dormway-lockedin design (glassmorphic effects, purple/pink/orange gradient)
- ✅ Dark-first design (#0f111c background instead of #1a1a1a)
- ✅ Full control over styling with inline CSS
...
Upload this file to Customer.io (Content → Layouts) and set as default for all DormWay campaigns.
...
**⚠️ CRITICAL FOR EMAIL CAMPAIGNS**
...
- **Current Status:** Events are tracked ✅, but user properties are not being set ❌
...
- **Testing Plan:** Verification steps for Amplitude → Customer.io integration
...
**Customer.io Template ID:** `syllabus-processed` (already deployed ✅)
...
- Weekly digest: >35% open rate, below 2% unsubscribe rate
...
1. **Welcome Email** - Immediate (transactional) ✅ Template ready
...
5. **Syllabus Success** - Immediate (transactional) ✅ Already deployed + Template ready
...
9. **Weekly Digest** - Every Monday 8am ✅ Template ready
10. **Daily Plan** - Every day 6am (optional) ✅ Template ready
...
- **Syllabus Upload Flow:** Push (processing) → Push (complete) → Email (detailed results)
- **Re-engagement Flow:** Email (Day 7) → Push (Day 10) → Email (Day 14)
- **Weekly Digest:** Email (Monday 8am) → Push (if not opened in 24h)
...
```
docs/email-journey/
├── 🆕 ⭐ CUSTOMER-IO-BEST-PRACTICES.md           # NEW: START HERE - Complete guide
├── 🆕 customerio-liquid-base-template.html       # NEW: Base layout for all emails
├── 🆕 liquid-snippets-library.md                 # NEW: HTML templates to copy-paste
├── 🆕 customerio-component-plan.md               # NEW: Updated implementation guide
├── 🆕 example-welcome-email-liquid.html          # NEW: Complete working example
├── customerio-campaign-flows.mermaid             # Campaign flow diagram
├── user-journey-timeline.mermaid                 # User journey timeline
├── email-visual-design-system.md                 # Complete design specs (legacy)
├── email-template-welcome.html                   # Welcome email (legacy HTML)
├── email-template-syllabus-success.html          # Syllabus success (legacy HTML)
├── email-template-weekly-digest.html             # Weekly digest (legacy HTML)
├── email-template-daily-plan.html                # Daily plan (legacy HTML)
├── campaign-architecture-diagram.mermaid         # System architecture
├── implementation-checklist.md                   # 12-week implementation plan (legacy)
├── ICON-UPDATE-SUMMARY.md                        # Professional icons documentation
...
## Migration Guide: EMC → Liquid Templates
...
✅ **Better compatibility** - Table-based layouts work in all email clients
✅ **Design consistency** - Matches dormway-lockedin exactly
✅ **Full control** - Inline CSS for precise styling
✅ **Easier maintenance** - Standard HTML/Liquid templates
✅ **Proven patterns** - Industry-standard email development
...
⚠️ **Important**: Customer.io snippets cannot reference message body variables. Always paste HTML directly!
