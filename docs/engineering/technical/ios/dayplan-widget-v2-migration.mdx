...
- [WidgetAPIService](/docs/engineering/technical/ios/widgetapiservice) - iOS service for calling V2 endpoints
- [Dashboard BFF Architecture](/docs/engineering/architecture/bff-dashboard-v1) - Legacy BFF pattern (deprecated for widgets)
- [WIDGET_MIGRATION_GUIDE](/docs/engineering/technical/ios/widgetmigrationguide) - MicroGrid layout patterns
