...
See [Engineering/Technical/API/Canvas/Canvas OAuth Flow](/docs/engineering/technical/api/canvas/canvas-integration-timeline-october-2025#canvas-oauth-optional-for-schools-with-it-approval) for Canvas LMS OAuth patterns.
