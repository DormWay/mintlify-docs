...
### DORM-F0-1: Database Schema Extensions ✅ COMPLETE
...
- ✅ Indexes exist for `user_id`, `insight_type`, `shown_at`, context GIN
- ✅ Foreign keys properly constrained
- ✅ Default values set correctly

---

### DORM-F0-2: CSS Foundation ✅ COMPLETE
...
**Acceptance Criteria**:
- ✅ All classes work in dark mode
- ✅ Light mode overrides included
...
### DORM-F0-3: TypeScript Types ✅ COMPLETE
...
### DORM-F0-4: API Endpoints ✅ COMPLETE
...
### DORM-F1-1: Widget Surface Styles ✅ COMPLETE
**Priority**: P1
**Estimate**: 3 hours
**Assignee**: Frontend
...
**Acceptance Criteria**:
- ✅ All widgets have consistent glassmorphic background
- ✅ Hover states show elevation change
- ✅ No visual glitches or flickering
- ✅ Works on mobile and desktop

---

### DORM-F1-2: ActionCTAWidget Enhancement ✅ COMPLETE
**Priority**: P1
**Estimate**: 2 hours
**Assignee**: Frontend
...
**Acceptance Criteria**:
- ✅ insightReason displays when available
- ✅ Sparkle icon indicates AI-generated content
- ✅ Graceful fallback when no insight
- ✅ Expandable "Why this?" panel works

---

### DORM-F1-3: TasksWidget Improvements ✅ COMPLETE
**Priority**: P1
**Estimate**: 2 hours
**Assignee**: Frontend
**Status**: ✅ Complete (2025-12-08)
...
- [x] Add hover checkmark overlay (Circle → CheckCircle on hover)
...
**Acceptance Criteria**:
- ✅ Overdue tasks have urgent border
- ✅ Course badges have subtle color background
- ✅ Due dates show as colored badges
- ✅ Hover reveals completion action

---

### DORM-F1-4: Schedule Widget Polish ✅ MOSTLY COMPLETE
**Priority**: P2
**Estimate**: 1.5 hours
**Assignee**: Frontend
**Status**: ✅ Mostly Complete (2025-12-08) - some items deferred
...
**Acceptance Criteria**:
- ✅ Empty state feels positive, not broken
- ✅ Context-aware messages (weekend, morning, evening)
- ⏸️ Attendance warnings (deferred - needs syllabus integration)

---

### DORM-F1-5: Micro-Animations ✅ COMPLETE
**Priority**: P2
**Estimate**: 1.5 hours
**Assignee**: Frontend
**Depends On**: DORM-F0-2
...
**Acceptance Criteria**:
- ✅ Animations complete in < 300ms total
...
### DORM-F2-1: Syllabus Insight Extraction 🟡 PARTIAL
**Priority**: P1
**Estimate**: 4 hours
**Assignee**: AI/Backend
...
**Acceptance Criteria**:
- ⏸️ 80%+ of syllabi generate valid insights (needs prompt enhancement)
...
### DORM-F2-2: Dashboard BFF Insight Integration ✅ COMPLETE
**Priority**: P1
**Estimate**: 2 hours
**Assignee**: Backend
...
**Acceptance Criteria**:
- ✅ NextAction includes insightReason when available
- ✅ Cache invalidates when insights update
- ✅ Response time < 200ms
...
### DORM-F2-4: Insight Attribution UI ✅ COMPLETE
**Priority**: P1
**Estimate**: 2 hours
**Assignee**: Frontend
...
**Acceptance Criteria**:
- ✅ Attribution visible on expand
- ⏸️ Dismiss works and persists (UI ready, backend wiring pending)
- ⏸️ Preference changes saved (UI ready, backend wiring pending)
...
**Status**: ✅ Backend + Hook Complete, Integration Pending (2025-12-08)
...
**Acceptance Criteria**:
- ✅ All layout changes can be logged
- ✅ Context captured accurately
- ✅ No noticeable performance impact
- ✅ Events synced within 2-5 seconds
- ⏸️ Integration into page.tsx pending

---

### DORM-F3-2: Insight Interaction Tracking 🟡 BACKEND ONLY
**Priority**: P2
**Estimate**: 2 hours
**Assignee**: Frontend
**Depends On**: DORM-F0-4
**Status**: 🟡 Backend Complete, Frontend Hook Missing (2025-12-08)
...
- ⏸️ Frontend hook not created yet
- ⏸️ Integration pending

---

### DORM-F3-3: Analytics Views 🟡 PARTIAL
**Priority**: P2
**Estimate**: 3 hours
**Assignee**: Backend
**Depends On**: DORM-F3-1
**Status**: 🟡 Partial (2025-12-08)
...
**Acceptance Criteria**:
- ⏸️ Queries return < 100ms (partial)
- ⏸️ Views refresh nightly (not set up yet)
- ✅ Data aggregated properly
- ✅ Privacy preserved (no cross-user queries)
...
DORM-F0-4 (API Endpoints)
    ↓
DORM-F3-1 (Layout Event Logging) → DORM-F3-3 (Analytics) → DORM-F5-1 (Pattern Detection)
                                                                    ↓
...
DORM-F0-2 (CSS Foundation)
    ↓
DORM-F1-1 (Widget Surfaces) → DORM-F1-2 to DORM-F1-5 (All visual polish)
...
DORM-F2-1 (Syllabus Insights)
    ↓
DORM-F2-2 (BFF Integration) → DORM-F2-4 (Attribution UI)
...
- Breadcrumb shows Course → Assignment path
...
- Panel-to-panel navigation works (course → assignment)
