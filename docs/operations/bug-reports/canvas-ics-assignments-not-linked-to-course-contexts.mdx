...
description: "1. Course-context linkage parity has been improved and cross-listed normalization is partially hardened. 2. Remaining critical gap is **completion-state cert..."
---
...
1. Course-context linkage parity has been improved and cross-listed normalization is partially hardened.
2. Remaining critical gap is **completion-state certainty** for ICS-only connections (many schools do not expose completion in ICS).
3. Overdue UX must remain capability-aware so unknown completion is not treated as confirmed incomplete.
