...
source:
  ...
  paths:
    ...
    - "Engineering/Architecture/SoT - StudentWatcher.md"
    - "Engineering/Architecture/SoT - Sync Orchestration & Schedules.md"
    - "Engineering/Architecture/SoT - Context System.md"
    - "Engineering/Architecture/SoT - Database Model & Access Patterns (Neon).md"
